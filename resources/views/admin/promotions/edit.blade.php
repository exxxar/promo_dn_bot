    ...
    <form method="post" action="{{ route('promotions.store') }}">
        ...
        <table class="table mt-2">
            ...
            <tr>
                <td>Заголовок</td>
                <td>
                    <input type="text" value="{{$promotion->title}}" name="title" class="form-control" required>
                </td>
            </tr>
            <tr>
                <td>Описание</td>
            ...
            <tr>
                ...
                <td>
                    <input type="datetime-local" value="{{$promotion->start_at}}" name="start_at" class="form-control"
                           required>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="datetime-local" value="{{$promotion->end_at}}" name="end_at" class="form-control"
                           required>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="number" min="0" value="{{$promotion->activation_count}}" name="activation_count"
                           class="form-control" required>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea name="activation_text" class="form-control">{{$promotion->activation_text}}</textarea>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="number" min="0" name="refferal_bonus" value="{{$promotion->refferal_bonus}}"
                           class="form-control" required>
                </td>
            </tr>
